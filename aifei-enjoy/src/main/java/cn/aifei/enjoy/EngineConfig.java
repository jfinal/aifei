...
import cn.aifei.enjoy.ext.directive.*;
import cn.aifei.enjoy.util.StrUtil;
import cn.aifei.enjoy.expr.ast.Arith;
import cn.aifei.enjoy.expr.ast.ExprList;
import cn.aifei.enjoy.expr.ast.SharedMethodKit;
import cn.aifei.enjoy.ext.sharedmethod.SharedMethodLib;
import cn.aifei.enjoy.io.EncoderFactory;
import cn.aifei.enjoy.io.WriterBuffer;
import cn.aifei.enjoy.source.FileSource;
...
import cn.aifei.enjoy.source.StringSource;
import cn.aifei.enjoy.stat.Compressor;
import cn.aifei.enjoy.stat.Location;
import cn.aifei.enjoy.stat.OutputDirectiveFactory;
import cn.aifei.enjoy.stat.Parser;
...
public class EngineConfig {
    ...
    Map<String, Define> sharedFunctionMap = createSharedFunctionMap();		// new HashMap<>(512);
    private List<ISource> sharedFunctionSourceList = new ArrayList<>();		// for devMode only
    ...
    Map<String, Class<? extends Directive>> directiveMap = new HashMap<>(64);
    ...
    public synchronized void addSharedObject(String name, Object object) {
        if (sharedObjectMap == null) {
            sharedObjectMap = new HashMap<>(64);
    ...
    public void addDirective(String directiveName, Class<? extends Directive> directiveClass) {
        addDirective(directiveName, directiveClass, true);
    }
