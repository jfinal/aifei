...
import cn.aifei.enjoy.proxy.ProxyClassLoader;
...
public class FastFieldGetter extends FieldGetter {
    ...
    protected static Map<Class<?>, Proxy> cache = new ConcurrentHashMap<>(512);
     ...
     * 代理类
     */
    static class ProxyClass extends cn.aifei.enjoy.proxy.ProxyClass {
        ...
        public ProxyClass(Class<?> target) {
            ...
            name = target.getSimpleName() + "$$EnhancerByAifei_FieldGetter";
        }
    ...
    static class ProxyGenerator {
        ...
        String generate(ProxyClass proxyClass) {
            ...
            ret.append("import cn.aifei.enjoy.expr.ast.FastFieldGetter.Proxy;\n\n");
     ...
     * 代理编译器
     */
    static class ProxyCompiler extends cn.aifei.enjoy.proxy.ProxyCompiler {
        @Override
