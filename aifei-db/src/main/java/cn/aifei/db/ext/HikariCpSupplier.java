...
/**
 * HikariCpSupplier 整合 HikariCp JDBC 连接池
 * <p>
...
public class HikariCpSupplier implements Supplier<DataSource> {
	...
	public HikariCpSupplier(String jdbcUrl, String username, String password) {
		this.jdbcUrl = jdbcUrl;
		this.username = username;
		this.password = password;
	}

	public HikariCpSupplier(String jdbcUrl, String username, String password, String driverClass) {
		this.jdbcUrl = jdbcUrl;
		this.username = username;
		this.password = password;
	...
	public synchronized HikariCpSupplier start() {
		...
		if(StrUtil.notBlank(driverClass)){
		...
		if(StrUtil.notBlank(catalog)){
			config.setCatalog(catalog);
		}

		if(StrUtil.notBlank(connectionTestQuery)){
			config.setConnectionTestQuery(connectionTestQuery);
		}

		if(StrUtil.notBlank(poolName)){
