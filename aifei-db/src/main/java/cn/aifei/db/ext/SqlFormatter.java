...
/**
 * 代码来源：
 *    https://github.com/hibernate/hibernate-orm/blob/6.6.1/hibernate-core/src/main/java/org/hibernate/engine/jdbc/internal/BasicFormatterImpl.java
 *    较低版本有 bug，使用 6.6.1 版
 *
 ...
 */
public class SqlFormatter implements Function<String, String> {

	private static final String WHITESPACE = " \n\r\f\t";

	private static final Set<String> NON_FUNCTION_NAMES = new HashSet<String>() {{
		add("select");
		add("from");
		add("on");
		add("set");
	...
	private static class FormatProcess {
		...
		private String repeat(int indent) {
			StringBuilder ret = new StringBuilder(INDENT_STRING.length() * indent);
