...
/**
 * Prop. 用于从 CLASSPATH 或指定文件加载 properties 配置文件.
 */
public class Prop {
    ...
    public Prop(String fileName, String encoding) {
        ...
        try {
            ...
            if (inputStream != null) try {inputStream.close();} catch (IOException e) {Log.get(Prop.class).error(e.getMessage(), e);}
        }
    }
     ...
     * 追加系统属性到当前 Prop 对象
     */
    public Prop appendSystemProperties() {
