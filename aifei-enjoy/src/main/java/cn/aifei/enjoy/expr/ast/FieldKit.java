...
import cn.aifei.enjoy.expr.ast.FieldGetters.*;
...
public class FieldKit {
    ...
    private static final Map<Object, FieldGetter> fieldGetterCache = new ConcurrentHashMap<>(1024);
    ...
    private static FieldGetter[] init() {
        LinkedList<FieldGetter> ret = new LinkedList<>();
